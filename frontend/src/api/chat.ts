...
export const questionApi = {
  ...
  clarify: (recordId: number, data: any, controller?: AbortController) =>
    request.fetchStream(`/chat/record/${recordId}/clarify`, data, controller),
  clarifyAbandon: (recordId: number) =>
    request.post(`/chat/record/${recordId}/clarify`, { abandon: true }),
