...
class Settings(BaseSettings):
    ...
    GENERATE_SQL_QUERY_HISTORY_ROUND_COUNT: int = 10
    CLARIFICATION_MAX_ROUNDS: int = 5
    CLARIFICATION_SCHEMA_PREFILTER_ENABLED: bool = True
    TIME_RANGE_CLARIFICATION_ENABLED: bool = True
    SQL_TIME_FILTER_VALIDATION_ENABLED: bool = True
    METRIC_KIND_TIME_RULES_ENABLED: bool = True
    SQL_TIME_FILTER_MAX_RETRIES: int = 2
    SQL_EXECUTE_MAX_RETRIES: int = 3
    QUERY_EARLIEST_DATE: str = "2024-01-01"
